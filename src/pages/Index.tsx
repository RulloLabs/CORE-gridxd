...
const EcosystemBanner = () => (
  <section className="py-16 bg-background text-center relative overflow-hidden border-t border-b border-border/30">
    ...
    <div className="max-w-4xl mx-auto px-4 relative z-10">
      <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
        ...
        <div className="p-6 rounded-2xl border border-border bg-foreground/5 backdrop-blur hover:bg-foreground/10 transition-colors cursor-pointer group">
          ...
          <h4 className="font-bold text-foreground mb-2">Figma Plugin</h4>
          <p className="text-sm text-muted-foreground mb-4">Extrae iconos directamente desde tu canvas en Figma. Integración V2.</p>
          <span className="text-xs font-bold px-2 py-1 bg-pink-500/20 text-pink-600 dark:text-pink-400 rounded">Beta Disponible</span>
        </div>
        <div className="p-6 rounded-2xl border border-border bg-foreground/5 backdrop-blur hover:bg-foreground/10 transition-colors cursor-pointer group">
          <Terminal className="w-8 h-8 text-green-500 mb-4 group-hover:scale-110 transition-transform" />
          <h4 className="font-bold text-foreground mb-2">CLI Tool</h4>
          <p className="text-sm text-muted-foreground mb-4">Procesa carpetas masivas de sprites desde tu terminal local.</p>
          <span className="text-xs font-bold px-2 py-1 bg-green-500/20 text-green-600 dark:text-green-400 rounded">v1.1 Ready</span>
        </div>
      </div>
    </div>
  </section>
